...
object ExerciseImporter {
    ...
    fun parse(rawJson: String): List<Exercise> = json.decodeFromString(ListSerializer(ExerciseDto.serializer()), rawJson).map { it.toEntity() }
     ...
     */
    fun supplementalSeed(): List<Exercise> = hyroxStations + conditioningMachines + hyfitExercises + hyroxRun
    ...
    private fun station(id: String, name: String, modality: Modality, metric: MetricType, station: HyroxStation, equipment: String): Exercise =
