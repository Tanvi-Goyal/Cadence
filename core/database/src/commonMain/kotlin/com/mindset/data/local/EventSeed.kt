...
object EventSeed {
    ...
    private val divisionSpecs =
        listOf(
            DivSpec(
                ...
                Tier.OPEN,
                0,
                push = 102.0 to "102 kg",
                pull = 78.0 to "78 kg",
                farmers = 16.0 to "2×16 kg",
                sandbag = 10.0 to "10 kg",
                wallBallKg = 4.0,
                wallTargetM = 2.7,
            ),
            DivSpec(
                ...
                Tier.OPEN,
                1,
                push = 152.0 to "152 kg",
                pull = 103.0 to "103 kg",
                farmers = 24.0 to "2×24 kg",
                sandbag = 20.0 to "20 kg",
                wallBallKg = 6.0,
                wallTargetM = 3.0,
            ),
            ...
            DivSpec(
                ...
                Tier.PRO,
                3,
                push = 202.0 to "202 kg",
                pull = 153.0 to "153 kg",
                farmers = 32.0 to "2×32 kg",
                sandbag = 30.0 to "30 kg",
                wallBallKg = 9.0,
                wallTargetM = 3.0,
            ),
        )

    val divisions: List<EventDivisionEntity> =
        divisionSpecs.map { d ->
            EventDivisionEntity(
    ...
    val standards: List<EventSegmentStandardEntity> =
        buildList {
            ...
            divisionSpecs.forEach { d ->
                ...
                std(
                    ...
                    "wall-balls",
                    d.wallBallKg,
                    "${d.wallBallKg.toInt()} kg",
                    reps = 100,
                    heightM = d.wallTargetM,
                )
            }
        }
}
