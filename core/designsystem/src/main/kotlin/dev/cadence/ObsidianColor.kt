 ...
 * A second, dark-only Material 3 scheme that lives ALONGSIDE Kinetic Precision (see Color.kt);
 * the active scheme is chosen in [CadenceTheme] from [LocalThemeVariant].
 *
...
/** The Obsidian Performance (dark) color scheme, selectable in [CadenceTheme]. */
internal val ObsidianColorScheme = darkColorScheme(
    primary = Primary,
    onPrimary = OnPrimary,
