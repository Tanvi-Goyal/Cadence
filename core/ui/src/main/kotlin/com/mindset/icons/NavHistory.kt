...
val NavHistory: ImageVector
    get() {
        if (_NavHistory != null) {
            return _NavHistory!!
        }
        _NavHistory = ImageVector.Builder(
            name = "NavHistory",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _NavHistory: ImageVector? = null

@Preview
@Composable
private fun NavHistoryPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NavHistory, contentDescription = null)
    }
}
