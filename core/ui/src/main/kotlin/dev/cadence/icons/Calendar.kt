...
/** A calendar-month glyph (outlined frame with a window). Tinted at the call site. */
val CadenceIcons.Calendar: ImageVector
    get() {
        if (_Calendar != null) {
            return _Calendar!!
        }
...
private fun CalendarPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = CadenceIcons.Calendar, contentDescription = null)
    }
}
