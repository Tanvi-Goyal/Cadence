...
val NavAccount: ImageVector
    get() {
        if (_NavAccount != null) {
            return _NavAccount!!
        }
        _NavAccount = ImageVector.Builder(
            name = "NavAccount",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 960f,
...
private var _NavAccount: ImageVector? = null

@Preview
@Composable
private fun NavAccountPreview() {
    Box(modifier = Modifier.padding(12.dp)) {
        Image(imageVector = NavAccount, contentDescription = null)
    }
}
