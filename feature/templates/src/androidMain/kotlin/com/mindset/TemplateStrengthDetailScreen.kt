...
//                StartCta(
//                    onStart,
//                    Modifier.align(Alignment.BottomStart).padding(bottom = inner.calculateBottomPadding()),
//                )
//            }
//        }
//    }
...
//                    0.5f to colors.background.copy(alpha = 0.3f),
...
//        ).border(1.dp, colors.primary.copy(alpha = 0.2f), CircleShape).padding(horizontal = 13.dp, vertical = 5.dp),
//    ) {
...
//        ).border(1.dp, colors.primary.copy(alpha = 0.2f), MaterialTheme.shapes.medium).padding(16.dp),
//        verticalArrangement = Arrangement.spacedBy(8.dp),
//    ) {
//        Text(
...
//        Modifier.clip(
//            CircleShape,
//        ).background(colors.primary.copy(alpha = 0.1f)).padding(horizontal = 10.dp, vertical = 3.dp),
//    ) {
...
//                        Modifier.clip(
//                            CircleShape,
//                        ).background(colors.surfaceContainerHighest).padding(horizontal = 6.dp, vertical = 1.dp),
//                    ) {
...
//        ).background(
//            colors.surfaceContainer,
//        ).border(1.dp, colors.outlineVariant.copy(alpha = 0.3f), MaterialTheme.shapes.medium).animateContentSize(),
//    ) {
//        Row(
...
//        ) {
//            Box(
//                Modifier.size(48.dp).clip(MaterialTheme.shapes.small).background(colors.surfaceContainerHigh),
//                contentAlignment = Alignment.Center,
//            ) {
//                Icon(
//                    MindSetIcons.CoolDown,
//                    contentDescription = null,
//                    tint = colors.onSurfaceVariant,
...
//                Text(
//                    "${section.exercises.size} exercises",
//                    style = MaterialTheme.typography.bodySmall,
//                    color = colors.onSurfaceVariant,
//                )
//            }
...
//            48.dp,
//        ).clip(CircleShape).background(colors.surfaceContainer.copy(alpha = 0.5f)).clickable(onClick = onClick),
//        contentAlignment = Alignment.Center,
//    ) {
...
//                56.dp,
//            ).shadow(16.dp, CircleShape).clip(CircleShape).background(colors.primary).clickable(onClick = onStart),
